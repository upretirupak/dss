...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 14, 2023 at 07:26 PM
...
(1, 'Admin', 'admin', 'infovima93@gmail.com', '12345', 0);
...
INSERT INTO `tbl_cart` (`cartId`, `sId`, `productId`, `productName`, `price`, `quantity`, `image`, `customer_id`) VALUES
(69, '0ui848i03vek7j5qhb9f6nbuhg', 14, 'Chicken Momo', 100.00, 1, 'upload/3f6ee66606.jpg', 2),
(70, '98ih4pe3gm29c73um1vepnsm5r', 14, 'Chicken Momo', 100.00, 1, 'upload/3f6ee66606.jpg', 9),
(81, '8q3qa44lb7majb49erl2s8of0p', 14, 'Chicken Momo', 100.00, 1, 'upload/3f6ee66606.jpg', 10),
(83, '90hq285ldkvhhiq3pv3n6qqv9c', 14, 'Chicken Momo', 100.00, 1, 'upload/3f6ee66606.jpg', 11),
(84, '19in9h3pddiml4tjere7cv19b4', 13, 'Chicken Choumein', 120.00, 1, 'upload/0b34d2cb59.jpg', 12),
(85, 'a82pmb40d4lq5fq31snalf44at', 23, 'Veg Momo', 100.00, 1, 'upload/bf193ecb9d.jpg', 2),
(86, 'erkg1ooak1ts885i5pgagbc0np', 19, 'Chicken Thukpa', 160.00, 1, 'upload/2c35669a05.jpeg', 9),
(87, 'erkg1ooak1ts885i5pgagbc0np', 16, 'Chicken Chilli', 200.00, 1, 'upload/7b4c26e022.jpg', 10),
(94, 'g1lshrpou1imdht52090buuei9', 21, 'Chicken Kothey Momo', 130.00, 1, 'upload/273ec33ff4.jpg', 11),
(95, 'p62k8c02ctdbbov39ctscqc42i', 16, 'Chicken Chilli', 200.00, -1, 'upload/7b4c26e022.jpg', 12),
(96, 'ea1kiirq502um44fvbb7e048p7', 23, 'Veg Momo', 100.00, 1, 'upload/bf193ecb9d.jpg', 2);
...
(12, 'test user', 'Nepal', '9876543210', 'user@mail.com', '81dc9bdb52d04dc20036dbd8313ed055');
...
INSERT INTO `tbl_discount` (`id`, `product_id`, `product_name`, `discount`) VALUES
(1, 13, 'Chicken Choumein', 22),
(4, 14, 'Chicken Momo', 10),
(5, 15, 'Chicken Burger', 0);
...
--
ALTER TABLE `tbl_cart`
  MODIFY `cartId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=97;
