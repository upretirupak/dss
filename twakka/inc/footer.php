...
<div class="footer">
	<div class="footer_agile_inner_info_w3l">
		<div class="col-md-3 footer-left">
			<h2><a href="index.html"><span style="background-color:#111;padding:10px;font-size:18px;border-radius:10px;">twakka</span>
				<span style="color:darkorange;background-color:rgba(0,0,0,0);font-size:18px;padding:5px;">Cafe</span></a></h2>
			<p>The lounge and restaurant will be open seven days a week. We will offer special theme nights to
				attract new customers to Gabri's. The restaurant will be fine dining in a cozy atmosphere.</p>
			<br/>
			<h4>FOLLOW US</h4>
			<ul class="social-nav model-3d-0 footer-social w3_agile_social two">
															<li><a href="https://www.facebook.com" target="_new" class="facebook">
																  <div class="front"><i class="fa fa-facebook" aria-hidden="true"></i></div>
																  <div class="back"><i class="fa fa-facebook" aria-hidden="true"></i></div></a></li>
															<li><a href="https://www.instagram.com" target="_new" class="twitter">
				...
				<div class="col-md-5 sign-gd-two">
					...
					<div class="w3-address">
						<div class="w3-address-grid">
							...
							<div class="w3-address-right" id="contact">
								<h6>Phone Number</h6>
								<p>+9779816613689</p>
							</div>
						...
						<div class="w3-address-grid">
							...
							<div class="w3-address-right">
								<h6>Email Address</h6>
								<p>Email :<a href="twakka@gmail.com" style="color:darkorange;"> twakka@gmail.com</a></p>
							</div>
							<div class="clearfix"> </div>
						</div>
						<div class="w3-address-grid">
		...
		<p class="copy-right">&copy twakka Cafe. All rights reserved  </a></p>
	</div>
</div>
<!-- //footer -->
<!-- login -->
...
const userFullAddress = document.getElementById('address');
	...
	//	$("#checkoutForm").attr("action", "checkout.php");
		...
		else if ($("input:radio[name='payment']:checked").length === 0) {
