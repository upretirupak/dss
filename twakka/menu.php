            ...
            <div class="col-md-4 product-men">
              <div class="men-pro-item simpleCart_shelfItem">
                ...
                <div class="item-info-product ">
                  ...
                  <div class="info-product-price d-flex" style="display: flex; justify-content: space-around; flex-direction: column; width: 70%; margin: 0 auto; margin-top: 10px; ">
                    <span class="item_price">Rs.<?php echo $result['price']; ?></span>
                    <del></del>
                    <span class="item_price">
                      <?php
                      if ($result['discount'] != '') {
                        echo $result['discount'] . '<span>%OFF</span>';
                      } ?>
                    </span>
                  </div>
